...
\begin{abstract}
  ...
  Implementing reliable security protocols is a difficult task, and
  ...
  cryptography, although it still has a long way to go to be a practical
  language. 
...
and the theory behind its formal verification utilities in this section.
